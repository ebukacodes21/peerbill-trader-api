...
init:
	docker run -it --rm --network host --volume "/Users/george/workspace/github.com/ebukacodes21/peerbill-trader-api/db:/db" migrate/migrate:v4.17.0 create -ext sql -dir /db/migrations $(name)

force:
	docker run -it --rm --network host --volume "/Users/george/workspace/github.com/ebukacodes21/peerbill-trader-api/db:/db" migrate/migrate:v4.17.0 create -ext sql -dir /db/migrations force $(version)
...
mock:
	mockgen -package mockdb -destination db/mock/repository.go github.com/ebukacodes21/peerbill-trader-api/db/sqlc DatabaseContract
...
evans:
	docker run --rm -it -v "/Users/george/workspace/github.com/ebukacodes21/peerbill-trader-api:/mount:ro" \
