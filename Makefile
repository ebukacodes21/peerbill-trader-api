...
init:
	docker run -it --rm --network host --volume "/Users/george/peerbill-trader-api/db:/db" migrate/migrate:v4.17.0 create -ext sql -dir /db/migrations $(name)

force:
	docker run -it --rm --network host --volume "/Users/george/peerbill-trader-api/db:/db" migrate/migrate:v4.17.0 create -ext sql -dir /db/migrations force $(version)
