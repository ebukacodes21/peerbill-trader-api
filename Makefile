...
init:
	docker run -it --rm --network host --volume "/Users/george/workspace/peerbill-trader-api/db:/db" migrate/migrate:v4.17.0 create -ext sql -dir /db/migrations $(name)

force:
	docker run -it --rm --network host --volume "/Users/george/workspace/peerbill-trader-api/db:/db" migrate/migrate:v4.17.0 create -ext sql -dir /db/migrations force $(version)
...
mock:
	mockgen -package mockdb -destination db/mock/repository.go peerbill-trader-api/db/sqlc DatabaseContract
